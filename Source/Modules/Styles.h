...
const float TIMING_DIRECTION_X = KEYBOARD_BG_WIDTH - ITEM_HEIGHT - CONTROLS_OUTER_SPACE;
const float TIMING_DEPTH_X = TIMING_DIRECTION_X - ITEM_HEIGHT - SPACE;
const float TIMING_VARIANCE_X = TIMING_DEPTH_X - ITEM_HEIGHT - SPACE - 9.f;
