...
const float VELOCITY_ALTERNATE_X = VELOCITY_DEPTH_X + ITEM_HEIGHT + SPACE;
const float VELOCITY_VARIANCE_X = VELOCITY_ALTERNATE_X + ITEM_HEIGHT + SPACE;
...
const float TIMING_ALTERNATE_X = TIMING_DEPTH_X - ITEM_HEIGHT - SPACE;
const float TIMING_VARIANCE_X = TIMING_ALTERNATE_X - ITEM_HEIGHT - SPACE;
