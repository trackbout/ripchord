...
const float EDIT_LEFT_X = TRANSPOSE_BUTTON_X - ITEM_HEIGHT;
const float ALL_WHITE_X = EDIT_LEFT_X - ITEM_HEIGHT - SPACE;
const float SAVE_X = (EDITOR_WIDTH * 0.5f) - (ITEM_HEIGHT * 0.5f);
const float EDIT_RIGHT_X = TRANSPOSE_BUTTON_X + ITEM_HEIGHT + DOUBLE_SPACE;
const float ALL_BLACK_X = EDIT_RIGHT_X + ITEM_HEIGHT + SPACE;
