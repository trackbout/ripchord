...
const float POWER_X = SPACE + KEYBOARD_BG_WIDTH - ITEM_HEIGHT;
const float MENU_X = POWER_X - ITEM_HEIGHT - HALF_SPACE;
const float FAV_X = MENU_X - ITEM_HEIGHT - HALF_SPACE;
...
const int GEAR_MENU_BUTTON_COUNT = 8;
const float GEAR_MENU_BUTTON_HEIGHT = 40.f;
const float GEAR_MENU_BUTTON_WIDTH = 300.f;
const float GEAR_MENU_WIDTH = GEAR_MENU_BUTTON_WIDTH;
const float GEAR_MENU_HEIGHT = GEAR_MENU_BUTTON_HEIGHT * GEAR_MENU_BUTTON_COUNT;
const float GEAR_MENU_X = EDITOR_WIDTH * 0.5f - GEAR_MENU_WIDTH * 0.5f;
const float GEAR_MENU_Y = EDITOR_HEIGHT * 0.5f - GEAR_MENU_HEIGHT * 0.5f;
