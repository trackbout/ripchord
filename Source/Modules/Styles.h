...
const float CONTROLS_OUTER_SPACE = SPACE * 6;

const float VELOCITY_DEPTH_X = CONTROLS_OUTER_SPACE;
const float VELOCITY_DIRECTION_X = VELOCITY_DEPTH_X + ITEM_HEIGHT + SPACE;
const float VELOCITY_VARIANCE_X = VELOCITY_DIRECTION_X + ITEM_HEIGHT + SPACE;
...
const float TIMING_DEPTH_X = KEYBOARD_BG_WIDTH - ITEM_HEIGHT - CONTROLS_OUTER_SPACE;
const float TIMING_DIRECTION_X = TIMING_DEPTH_X - ITEM_HEIGHT - SPACE;
const float TIMING_VARIANCE_X = TIMING_DIRECTION_X - ITEM_HEIGHT - SPACE;
...
const float SAVE_X = SPACE + KEYBOARD_BG_WIDTH - (ITEM_HEIGHT * 2 + SPACE);
const float MENU_X = SAVE_X + ITEM_HEIGHT + SPACE;
